...
export const metadata: Metadata = {
  ...
  description:
    "Create your FixItNow account to book trusted technicians or take on jobs.",
};

const HIGHLIGHTS = [
  "Free to join — you only pay per job",
  "Vetted technicians, rated by real customers",
  "Track every booking from one dashboard",
];
      ...
      <section className="relative hidden overflow-hidden bg-[oklch(0.17_0.01_107)] p-12 text-[oklch(0.98_0.003_106)] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-md">
          <h2 className="font-heading text-4xl leading-[1.1] font-semibold tracking-tight text-balance">
            Join FixItNow.
            <span className="block text-primary">Get it fixed today.</span>
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-[oklch(0.98_0.003_106_/_0.65)]">
            One account to book plumbers, electricians and handymen — or to pick
            up jobs near you as a technician.
          </p>
          ...
          <Card className="border-border/70 shadow-xl shadow-black/[0.03]">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-xs">
                It takes a minute — no card needed to sign up.
              </CardDescription>
            </CardHeader>
